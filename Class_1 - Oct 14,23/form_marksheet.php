    ...
    <form action="#" method="post">
        <div class="container">
            ...
            <div class="col">
                ...
                <p id="errorTextSindhi" style="color: red;"></p>
            </div>
            <div class="col">
            ...
            <div class="col">
                <input type="number" min="0" max="100" id="urdu" name="urdu" class="form-control obtainedTotal">
                 <p id="errorTextUrdu" style="color: red;"></p>
            </div>
            <div class="col">
            ...
            <div class="col">
                ...
                <p id="errorTextEnglishI" style="color: red;"></p>
            </div>
            </div>
        <div class="row g-3 align-items-center">
            <div class="col">
            ...
            <div class="col">
                ...
                <p id="errorTextEnglishII" style="color: red;"></p>
            </div>
            <div class="col">
            ...
            <div class="col">
                ...
                <p id="errorTextIslamiyat" style="color: red;"></p>
            </div>
            <div class="col">
            ...
            <div class="col">
                ...
                <p id="errorTextPS" style="color: red;"></p>
            </div>
        </div>
        <div class="row g-3 align-items-center">
            <div class="col">
            ...
            <div class="col">
                ...
                <p id="errorTextPhysics_T" style="color: red;"></p>
            </div>
            <div class="col">
            ...
            <div class="col">
                ...
                <p id="errorTextPhysics_P" style="color: red;"></p>
            </div>
            <div class="col">
            ...
            <div class="col">
                ...
                <p id="errorTextChemistry_T" style="color: red;"></p>
            </div>
        </div>
        <div class="row g-3 align-items-center">
            <div class="col">
            ...
            <div class="col">
                ...
                <p id="errorTextChemistry_P" style="color: red;"></p>
            </div>
            <div class="col">
            ...
            <div class="col">
                ...
                <p id="errorTextMathematics" style="color: red;"></p>
            </div>
            <div class="col">
            ...
            <div class="col">
                ...
                <p id="errorTextBiology_T" style="color: red;"></p>
            </div>
        </div>
        <div class="row g-3 align-items-center">
            <div class="col-2">
            ...
            <div class="col-2">
                ...
                <p id="errorTextBiology_P" style="color: red;"></p>
            </div>
            <div class="col-6">
                <button type="submit" name="submit" id="submit" class="btn btn-primary">Generate Result</button>
            </div>
        </div>
        <div class="row g-3 align-items-center">
...
<script type="text/javascript">
    ...
    $(document).on('keyup','.obtainedTotal',function(){
        checkSubjectValue();
    })
    function checkSubjectValue()
    {
        var sindhi       = $('#sindhi').val();
        var urdu         = $('#urdu').val(); 
        var englishI     = $('#englishI').val();
        var englishII    = $('#englishII').val();
        var islamiyat    = $('#islamiyat').val();
        var ps           = $('#ps').val();
        var physics_T    = $('#physics_T').val();
        var physics_P    = $('#physics_P').val();
        var chem         = $('#chem').val();
        var chem_P       = $('#chem_P').val();
        var math         = $('#math').val();
        var bio_T        = $('#bio_T').val();
        var bio_P        = $('#bio_P').val();

        if(urdu !=null && parseInt(urdu)> 99)
        { 
            $("#errorTextUrdu").text("Value cannot be greater than 99");
         ...
         if(sindhi !=null && parseInt(sindhi)> 99)
        { 
            $("#errorTextSindhi").text("Value cannot be greater than 99");
            $('#submit').prop('readonly', true)

        }else{
             $("#errorTextSindhi").text("");
             $('#submit').prop('readonly', false)
        }
         if(englishI !=null && parseInt(englishI)> 99)
        { 
            $("#errorTextEnglishI").text("Value cannot be greater than 99");
            $('#submit').prop('readonly', true)

        }else{
             $("#errorTextEnglishI").text("");
             $('#submit').prop('readonly', false)
        }
         if(englishII !=null && parseInt(englishII)> 99)
        { 
            $("#errorTextEnglishII").text("Value cannot be greater than 99");
            $('#submit').prop('readonly', true)

        }else{
             $("#errorTextEnglishII").text("");
             $('#submit').prop('readonly', false)
        }
         if(islamiyat !=null && parseInt(islamiyat)> 99)
        { 
            $("#errorTextIslamiyat").text("Value cannot be greater than 99");
            $('#submit').prop('readonly', true)

        }else{
             $("#errorTextIslamiyat").text("");
             $('#submit').prop('readonly', false)
        }
         if(ps !=null && parseInt(ps)> 99)
        { 
            $("#errorTextPS").text("Value cannot be greater than 99");
            $('#submit').prop('readonly', true)
         ...
         if(physics_T !=null && parseInt(physics_T)> 99)
        { 
            $("#errorTextPhysics_T").text("Value cannot be greater than 99");
            $('#submit').prop('readonly', true)

        }else{
             $("#errorTextPhysics_T").text("");
             $('#submit').prop('readonly', false)
        }
         if(physics_P !=null && parseInt(physics_P)> 99)
        { 
            $("#errorTextPhysics_P").text("Value cannot be greater than 99");
            $('#submit').prop('readonly', true)

        }else{
             $("#errorTextPhysics_P").text("");
             $('#submit').prop('readonly', false)
        }
         if(chem !=null && parseInt(chem)> 99)
        { 
            $("#errorTextChemistry_T").text("Value cannot be greater than 99");
            $('#submit').prop('readonly', true)

        }else{
             $("#errorTextChemistry_T").text("");
             $('#submit').prop('readonly', false)
        }
         if(chem_P !=null && parseInt(chem_P)> 99)
        { 
            $("#errorTextChemistry_P").text("Value cannot be greater than 99");
            $('#submit').prop('readonly', true)

        }else{
             $("#errorTextChemistry_P").text("");
             $('#submit').prop('readonly', false)
        }
         if(math !=null && parseInt(math)> 99)
        { 
            $("#errorTextMathematics").text("Value cannot be greater than 99");
            $('#submit').prop('readonly', true)

        }else{
             $("#errorTextMathematics").text("");
             $('#submit').prop('readonly', false)
        }
         if(bio_T !=null && parseInt(bio_T)> 99)
        { 
            $("#errorTextBiology_T").text("Value cannot be greater than 99");
            $('#submit').prop('readonly', true)

        }else{
             $("#errorTextBiology_T").text("");
             $('#submit').prop('readonly', false)
        }
         if(bio_P !=null && parseInt(bio_P)> 99)
        { 
            $("#errorTextBiology_P").text("Value cannot be greater than 99");
            $('#submit').prop('readonly', true)

        }else{
             $("#errorTextBiology_P").text("");
             $('#submit').prop('readonly', false)
        }
